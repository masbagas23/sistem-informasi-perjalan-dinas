...
const mutations = {
    ...
    ASSIGN_FORM(state, payload) {
        state.form = {
            details: payload.expense.details,
            total_nominal: payload.expense.total_nominal,
        };
    },
...
const actions = {
    ...
    load({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            $axios
                .get(`/report-expenses`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/report-expense-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/report-expenses`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/report-expenses/${payload}`).then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/report-expenses/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    destroy({ }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/report-expenses/${payload}`)
                .then((response) => {
