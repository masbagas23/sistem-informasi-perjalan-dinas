...
const actions = {
    ...
    load({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            $axios
                .get(`/job-categories`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/job-category-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/job-categories`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/job-categories/${payload}`).then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/job-categories/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
