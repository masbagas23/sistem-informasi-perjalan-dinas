                ...
                <b-row>
                    ...
                    <b-col cols="12">
                        <div class="form-group">
                            ...
                            <b-form-textarea :class="{ 'has-error': errors.description }" v-model="form.description" placeholder="Penjelasan pekerjaan..." rows="3" max-rows="6" ></b-form-textarea>
...
export default {
    ...
    methods: {
        ...
        ...mapMutations('mstJobCategory', ['CLEAR_FORM']),
        ...mapActions('mstJobCategory', ['show']),
