...
export default {
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.admin.mstJobCategory.tableParams;
            },
            set(params) {
                this.$store.commit("mstJobCategory/SET_TABLE_PARAMS", params);
            }
        }
    },
    mounted(){
    ...
    methods: {
        ...
        create() {
            this.$bvModal.show("modal-form-job-category");
        },
        view(id) {
            this.modelId = id;
            this.create();
        ...
        hideModal(loading) {
            ...
            this.$bvModal.hide("modal-form-job-category");
        },
