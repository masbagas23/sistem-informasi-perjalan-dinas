    ...
    data() {
        return {
            fields: [
                ...
                { key: "nip", label: "NIP", sortable: false, thStyle: "text-align: center; width: 80px;"},
                { key: "name", label: "Nama", sortable: false },
                { key: "job_position", label: "Jabatan", sortable: false },
                { key: "phone_number", label: "Nomor HP", sortable: false },
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.admin.mstUser.tableParams;
            },
            set(params) {
                this.$store.commit("mstUser/SET_TABLE_PARAMS", params);
            }
        }
    },
    watch: {
