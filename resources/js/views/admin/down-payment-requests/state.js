...
const actions = {
    ...
    load({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            $axios
                .get(`/down-payment-requests`, { params: payload })
                .then(response => {
    ...
    store({ commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/down-payment-requests`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/down-payment-requests/${payload}`).then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/down-payment-requests/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    destroy({ }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/down-payment-requests/${payload}`)
                .then((response) => {
    ...
    cancel({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .post(`/down-payment-request-cancel/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    approve({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .post(`/down-payment-request-approval/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
