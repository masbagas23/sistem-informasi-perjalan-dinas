...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: "number_plate_license", label: "Plat Nomor", sortable: false },
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.admin.mstVehicle.tableParams;
            },
            set(params) {
                this.$store.commit("mstVehicle/SET_TABLE_PARAMS", params);
            }
        }
    },
    mounted(){
    ...
    methods: {
        ...
        create() {
            this.$bvModal.show("modal-form-vehicle");
        },
        view(id) {
            this.modelId = id;
            this.create();
        ...
        hideModal(loading) {
            ...
            this.$bvModal.hide("modal-form-vehicle");
        },
