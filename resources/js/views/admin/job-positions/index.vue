...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: "role", label: "Hak Akses", sortable: false },
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.admin.mstJobPosition.tableParams;
            },
            set(params) {
                this.$store.commit("mstJobPosition/SET_TABLE_PARAMS", params);
            }
        }
    },
    mounted(){
    ...
    methods: {
        ...
        create() {
            this.$bvModal.show("modal-form-job-position");
        },
        view(id) {
            this.modelId = id;
            this.create();
        ...
        hideModal(loading) {
            ...
            this.$bvModal.hide("modal-form-job-position");
        },
