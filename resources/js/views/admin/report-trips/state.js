...
const actions = {
    ...
    load({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            $axios
                .get(`/report-trips`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/report-trip-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    show({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/report-trips/${payload}`).then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/report-trips/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
