...
const actions = {
    ...
    load({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            $axios
                .get(`/cost-categories`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/cost-category-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/cost-categories`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/cost-categories/${payload}`).then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/cost-categories/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    // commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    destroy({ }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/cost-categories/${payload}`)
                .then((response) => {
