        ...
        <b-card class="text-center">
            ...
            >
                ...
                <template v-slot:cell(vehicle)="row">
                    <span title="Plat Nomor">{{ row.value.number_plate_license }}</span> - <span title="Kendaraan">{{ row.value.name }}</span>
                </template>
    ...
    data() {
        return {
            fields: [
                ...
                { key: "vehicle", label: "Kendaraan", sortable: false },
            ...
            keyword: "",
            modelId: "",
            fileTitle: "Peminjaman Kendaraan"
        };
    },
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.admin.vehicleLoan.tableParams;
            },
            set(params) {
