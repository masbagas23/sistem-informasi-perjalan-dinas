...
function success(module, type) {
  Vue.toasted.success("".concat(module, " Berhasil di").concat(type), {
    position: "top-right",
    duration: 5000
  });
}
...
function error(module, type) {
  Vue.toasted.error("".concat(module, " Gagal di").concat(type), {
    position: "top-right",
    duration: 5000
  });
}
    ...
    _c("div", { staticClass: "container" }, [
      _vm.verificationStatus
        ? _c("div", { staticClass: "row justify-content-center" }, [
            _c("div", { staticClass: "col-xl-6 col-lg-8 col-md-9" }, [
              _c(
                "div",
                {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "text-center pb-5" }, [
      _c("img", { attrs: { src: "/images/logo.png", width: "180vh", alt: "" } })
    ])
  }
]
